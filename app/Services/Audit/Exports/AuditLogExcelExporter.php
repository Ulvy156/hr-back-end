...
namespace App\Services\Audit\Exports;
...
class AuditLogExcelExporter
{
    ...
    public function store(string $path, array $report): void
    {
        ...
        if ($status !== true) {
            throw new \RuntimeException('Unable to create audit log Excel export archive.');
        }
    ...
    private function rows(array $report): array
    {
        ...
        foreach ($report['records'] as $record) {
            $rows[] = [
                ['value' => $record['id'] ?? null, 'style' => 0],
                ['value' => $record['logName'] ?? null, 'style' => 0],
                ['value' => $record['event'] ?? null, 'style' => 0],
                ['value' => $record['description'] ?? null, 'style' => 0],
                ['value' => $record['batchUuid'] ?? null, 'style' => 0],
                ['value' => $record['createdAt'] ?? null, 'style' => 0],
                ['value' => $record['causer']['type'] ?? null, 'style' => 0],
                ['value' => $record['causer']['id'] ?? null, 'style' => 0],
                ['value' => $record['causer']['name'] ?? null, 'style' => 0],
                ['value' => $record['causer']['email'] ?? null, 'style' => 0],
                ['value' => $record['subject']['type'] ?? null, 'style' => 0],
                ['value' => $record['subject']['id'] ?? null, 'style' => 0],
                ['value' => $record['subject']['label'] ?? null, 'style' => 0],
                ['value' => $this->stringify($record['changes']['attributes'] ?? []), 'style' => 0],
                ['value' => $this->stringify($record['changes']['old'] ?? []), 'style' => 0],
                ['value' => $this->stringify($record['metadata'] ?? []), 'style' => 0],
            ];
        }
