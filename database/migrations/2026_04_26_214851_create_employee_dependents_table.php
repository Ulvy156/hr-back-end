...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employee_dependents', function (Blueprint $table) {
            ...
            $table->boolean('is_claimed_for_tax')->default(false)->index();
            $table->timestamps();

            $table->index(['employee_id', 'is_active']);
            $table->index(['employee_id', 'relationship', 'is_active', 'is_claimed_for_tax'], 'employee_dependents_tax_lookup_idx');
        });
