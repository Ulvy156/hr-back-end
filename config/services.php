...
return [
    ...
    */
    ...
    'passport' => [
        ...
        'refresh_cookie_domain' => env('PASSPORT_REFRESH_COOKIE_DOMAIN'),
        'refresh_cookie_secure' => env('PASSPORT_REFRESH_COOKIE_SECURE', false),
        'refresh_cookie_same_site' => env('PASSPORT_REFRESH_COOKIE_SAME_SITE', env('SESSION_SAME_SITE', 'lax')),
    ],
